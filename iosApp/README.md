...
| `version.properties` | Android 版號 | 目前 **1.2.9 / code 11** · 主畫面 `v1.2.9` |
| `iosApp/.../Info.plist` + Xcode | iOS 版號 | 目前 **1.2.9 (19)** · **狀態頁顯示 `v1.2.9 (19)`** |
...
| 預編 IPA | ✅ `dist/…ipa` **1.2.9 (19)** | — |

### 路測對版（必看）

1. 打開 App → **狀態** 頁右上角 / 副標：**`v1.2.9 (19)`**  
2. Session log 開頭：`appVersion=1.2.9` `build=19`  
