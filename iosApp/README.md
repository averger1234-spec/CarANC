...
| `version.properties` | Android 版號 | 目前 **1.2.12 / code 14** · 主畫面 `v1.2.12` |
| `iosApp/.../Info.plist` + Xcode | iOS 版號 | 目前 **1.2.12 (20)** · **狀態頁顯示 `v1.2.12 (20)`** |
...
| 能力 | iOS 現況 | Android |
|------|----------|---------|
| 版號顯示 | ✅ 狀態頁 `v1.2.12 (20)` | ✅ 主畫面 `v1.2.12` |
...
| 預編 IPA | ✅ `dist/…ipa` **1.2.12 (20)** | — |

### 路測對版（必看）

1. 打開 App → **狀態** 頁右上角 / 副標：**`v1.2.12 (20)`**  
2. Session log 開頭：`appVersion=1.2.12` `build=20`  
