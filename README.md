...
**版號**：Android **`version.properties` → 1.2.5 / code 7** · iOS **Info.plist → 1.2.5 (16)**（1.2.4 KMP 待重編 IPA）· 改版見 **[`CHANGELOG.md`](CHANGELOG.md)**  
...
| **iOS 版號** | **`1.2.5` (build 16)** · 狀態頁 **`v1.2.5 (16)`** | ✅ |
...
# iOS：見 iosApp/README.md 或 dist/*.ipa → 狀態頁看 v1.2.5 (16)
```
