...
**版號**：Android **`version.properties` → 1.2.6 / code 8** · iOS **Info.plist → 1.2.6 (17)** · 改版見 **[`CHANGELOG.md`](CHANGELOG.md)**  
...
| 項目 | 說明 | 狀態 |
|------|------|------|
| **Android 版號** | **`1.2.6` / code `8`** · 主畫面 `v1.2.5` | ✅ |
| **iOS 版號** | **`1.2.6` (build 17)** · 狀態頁 **`v1.2.6 (17)`** | ✅ |
...
# iOS：見 iosApp/README.md 或 dist/*.ipa → 狀態頁看 v1.2.6 (17)
```
