...
- **實車引導測試**：
  - `car_field_v3`：一般實車驗證（延遲、MIMO、怠速、市區、高速、音樂 bypass 等；含「無電台靜電」檢查）
  - `car_road_tuning_v1`：路噪快速迭代（#4b A/B + #6/#7；驗 **HIGH_LAT_PRED_BANK** / neuralLatent / imuMicCoherence / bankMatch* / lowBandRumbleReduction / 無靜電；ov 僅 log）
