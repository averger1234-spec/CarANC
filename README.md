...
**版號**：Android **`version.properties` → 1.2.9 / code 11** · iOS **Info.plist → 1.2.6 (18)**（Android 1.2.7 算法；iOS 腳本文案已對齊，KMP framework 待重編） · 改版見 **[`CHANGELOG.md`](CHANGELOG.md)**  
...
| 項目 | 說明 | 狀態 |
|------|------|------|
| **Android 版號** | **`1.2.9` / code `11`** · 主畫面 `v1.2.9` | ✅ |
...
```bash
git pull origin main
# Android：.\scripts\install-debug.ps1  → 主畫面看 v1.2.9
