...
現行路測版：**Android 1.2.30 / code 32** · **iOS 1.2.30 (29)**。AA / CarPlay 低音路徑見 repo 根 [`FORUM_AUDIO_PATH.md`](../FORUM_AUDIO_PATH.md)。
...
1. `git pull` 後用 Xcode 編 **iOS 1.2.30 (29)**，狀態頁 `v1.2.30 (29)`（`dist` 舊 IPA 不是這版）
