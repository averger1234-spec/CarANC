...
| 平台 | 版號 | App 怎麼對版 |
|------|------|----------------|
| Android | **1.2.12 / code 14** | 主畫面 `v1.2.12` |
| iOS | **1.2.12 (build 21)** | 狀態頁 **`v1.2.12 (21)`**；mute+極性A/B+艙錄；**通話結束車機音量暴衝已修** |
...
| **Windows 裝 iPhone（Sideloadly）** | `dist/WINDOWS_INSTALL_SIDELOADLY.md`（應寫 1.2.12 (21)） |
