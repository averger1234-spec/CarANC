- �h�� AA + �S�w rumble ���� + music on/off ��ӡC
- �O���ɥ� scenario �� "musicLow=ON, userGain=0.8, no_music, rough_road_50kmh"�C
- �ץX log �����R�Afocus low freq reduction / anti energy / lms rate�C
- ���b�D AA phone speaker �إ� baseline�A�A AA ����C

���w��s�]�t�o�ǡCpull ����աA�ﵽ�|�����p�G���󱱨�n�C�i�׬O�ֿn���AANC �b�u�ꨮ��/AA ���ӴN subtle�]�X dB �C�W�ﵽ�N���\�^�C
...
抓 log 方法：
- 每次組合跑完 → 立即在 TestLogPanel 按「匯出 Log」或手動複製最新 session log。
...
## 腳本更新 + 第一次實車測試推薦參數組合（2026-06-26）

### 腳本更新
- AncTestScript.kt：
  - 新增 `CarRoadTuningScript`（SCRIPT_ID = "car_road_tuning_v1"），完全依照你提供的 5 組順序設計。
  - 每個 tuning step 現在會在進入時透過 `debug_presets_apply` 事件**自動套用**對應的 muMult / freezeThreshold / freezeConsec / latencyOverride + forceNormal / musicLowAnc / userAncGain。
  - monitoredSnapshotFields 已擴充所有 debug*、*BandMuScale、antiNoiseDb、lms*、freeze*、processingMode、dominantNoiseBand 等關鍵欄位。
- GuidedTestController.kt：進入步驟時如果有 debugPresets 就會 emit 事件自動套用。
- GuidedTestPanel.kt：
  - Idle 畫面現在有兩個按鈕：「標準 v3 實車測試」與「開始路噪調校測試（推薦）」。
  - 強烈建議第一次實車（你個人 phone + USB AA + 車）直接按「開始路噪調校測試（推薦）」。
  - 調校腳本執行時，TestLogPanel 的進階滑桿**不需要手動調整**，腳本會自動控制。
...
（TestLogPanel 裡的 debug 滑桿在這個推薦腳本執行期間可以忽略，實際值會由腳本自動寫入 prefs 並記錄到 log。）

### 建議第一次實車測試的參數組合（完全照你給的順序）
請用以下順序測試（同一段粗糙路面，40-70km/h，無/低音樂）：

| 測試編號 | muMult | freezeThreshold | freezeConsecutive | latencyOverride | 預期觀察重點 |
|----------|--------|-----------------|-------------------|-----------------|--------------|
| #1 (Baseline) | 1.0 | 15 | 3 | 0 | 目前穩定度（lms 上升是否正常、freeze 很少） |
| #2 | 1.3 | 14 | 3 | 0 | 看 lmsUpdateCount / lowBandLmsUpdateCount 是否明顯上升 |
| #3 | 1.5 | 12 | 2 | 0 | 較積極適應，觀察 freezeBlocksRemaining 是否太頻繁 |
| #4 | 1.5 | 12 | 2 | 80 | 強制低延遲，看 mid band 是否開始有貢獻（bandMuScale、midGain、midEnabled） |
| #5 | 1.8 | 13 | 3 | 0 | 再激進一點，注意 antiArtifactGain 是否有壓制白噪、antiNoiseDb 是否更負 |

**執行重點**：
- 參數已由腳本**自動套用**（進入步驟時自動寫入 prefs），你不需要手動調整 TestLogPanel 的 debug 控制項。
- 全程用 **PRO + forceNormal=ON + musicLowAnc=ON + userAncGain 0.75~0.9**（這些在 prep 步驟也會自動設定）。
- 每組跑 60-90 秒後按「完成這步」，讓 log 產生 test_step_snapshot 方便對照。
- 跑完 5 組務必匯出，scenario 或 log 檔名記 "tuning#X_mu1.5_f12_c2_o0" 之類（或在 user note 補充）。
- 建議在 TestLogPanel 看到「當使用調校腳本時...不需要手動調整」的提醒。

更新後直接 rebuild，開 Guided Test 選「路噪調校測試（推薦）」，跟腳本走就對了（全程幾乎不用碰 TestLogPanel 的調校滑桿）。跑完把 log 貼給我，我會用你指定的這些欄位（lmsUpdate、freezeRem、antiNoiseDb、reductionDb、maxCancel、processingMode、latency+override、band*MuScale、dominantNoiseBand）幫你做精準分析與下一輪建議。

這組就是你第一次實車最該跑的 5 組對照，謝謝提供明確表格！
