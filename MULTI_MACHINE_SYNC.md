...
| iOS | **1.2.15 (build 26)** | 狀態頁 **`v1.2.15 (26)`**；boomOut+中頻winner；**anc_logs 存檔+分享 log/wav**；Embed 防閃退 |
...
| **Windows 裝 iPhone（Sideloadly）** | `dist/WINDOWS_INSTALL_SIDELOADLY.md`（應寫 1.2.15 (26)） |
